  ...
  return (
    <div style={{ height: "700px" }}>
      <div
        ...
        data-carousel="slide"
      >
        <div className="relative  overflow-hidden rounded-base md:h-96">
          <div
          ...
          <div className="hidden duration-700 ease-in-out" data-carousel-item>
            <img
              src="https://images.pexels.com/photos/220067/pexels-photo-220067.jpeg"
              className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
              alt="..."
            />
          </div>
          ...
          <div className="hidden duration-700 ease-in-out" data-carousel-item>
            <img
              src="https://images.pexels.com/photos/1227511/pexels-photo-1227511.jpeg"
              className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
              alt="..."
            />
          </div>
