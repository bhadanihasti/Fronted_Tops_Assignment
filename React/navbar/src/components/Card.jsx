...
function Card() {
  return (
    <div>
      <div className="text-3xl mt-15 mb-15 ml-auto text-center font-black">
      ...
      <div style={{ display: "flex" }}>
        <div class="bg-neutral-primary-soft block max-w-sm p-6 border border-default rounded-base shadow-xs">
          <a href="#">
            <img
              class="rounded-base"
              src="src\components\images\img-1.png"
              alt=""
            />
          </a>
          <a href="#">
          ...
          <p class="mb-6 text-body">looking at its layout. The point of</p>
          <a
            href="#"
        ...
        <div class="bg-neutral-primary-soft block max-w-sm p-6 border border-default rounded-base shadow-xs">
          <a href="#">
            <img
              class="rounded-base"
              src="src\components\images\img-2.png"
              alt=""
            />
          </a>
          <a href="#">
        ...
        <div class="bg-neutral-primary-soft block max-w-sm p-6 border border-default rounded-base shadow-xs">
          <a href="#">
            <img
              class="rounded-base"
              src="src\components\images\img-3.png"
              alt=""
            />
          </a>
          <a href="#">
